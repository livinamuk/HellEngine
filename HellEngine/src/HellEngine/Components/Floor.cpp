...
namespace HellEngine
{
	...
	Floor::Floor(glm::vec3 position, float width, float depth)
	{
		...
		float vertices[] = {
			// positions          // normals           // texture coords	
			 x2,  y,  z2,  0.0f,  1.0f,  0.0f,  0.0f * texScale.x,  depth * texScale.y,
			 x2,  y,  z1,  0.0f,  1.0f,  0.0f,  width * texScale.x,  depth * texScale.y,
			 x1,  y,  z1,  0.0f,  1.0f,  0.0f,  width * texScale.x,  0.0f * texScale.y,
			 x1,  y,  z1,  0.0f,  1.0f,  0.0f,  width * texScale.x,  0.0f * texScale.y,
